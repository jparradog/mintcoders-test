...
<form class=" form-horizontal well" id="<?PHP echo($ext); ?>">
    <fieldset>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <div class="input-append">
                    <input type="text" value="" class="input-xlarge focused" placeholder="Ej: johnDoes" name="<?PHP echo($ext); ?>-usuario" id="<?PHP echo($ext); ?>-usuario" required="required" maxlength=30 minlength=5 pattern="^[a-zA-Z][a-zA-Z0-9-_\.]{4,30}$">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <div class="input-append">
                    <input type="password" value="" class="input-xlarge focused" placeholder="Ej: hjk123PHD" name="<?PHP echo($ext); ?>-contra" id="<?PHP echo($ext); ?>-contra" required="required" maxlength=30 minlength=5 pattern="(?!^[0-9]*$)(?!^[a-zA-Z]*$)^([a-zA-Z0-9]{4,30})$">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <div class="input-append">
                    <input type="email" value="" class="input-xlarge focused" placeholder="Ej: johndoes@email.com" name="<?PHP echo($ext); ?>-email" id="<?PHP echo($ext); ?>-email" required="required" maxlength=40 minlength=5 pattern="^[a-z]+@[a-z]+\.[a-z]{2,4}$">
